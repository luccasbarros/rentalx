...
var CreateRentalUseCase = /** @class */ (function () {
    ...
    CreateRentalUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var compareHours, carUnavailable, rentalOpenToUser, dateNow, compare, rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (carUnavailable) {
                            throw new AppError_1.AppError("Car is unavailable", 400);
                        }
                        return [4 /*yield*/, this.rentalsRepository.findOpenRentalByUser(user_id)];
                    case 2:
                        rentalOpenToUser = _b.sent();
                        if (rentalOpenToUser) {
                            throw new AppError_1.AppError("You have an open rental", 400);
                        }
                        ...
                        if (compare < compareHours) {
                            throw new AppError_1.AppError("Expected return date is in the past", 400);
                        }
