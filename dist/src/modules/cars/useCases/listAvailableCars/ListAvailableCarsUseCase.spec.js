    ...
    it("should be able to list all available cars by brand", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    car = _a.sent();
                    return [4 /*yield*/, listAvailableCarsUseCase.execute({ brand: "Car_Brand_test" })];
                case 2:
                    cars = _a.sent();
                    expect(cars).toEqual([car]);
                    return [2 /*return*/];
    ...
    it("should be able to list all available cars by name", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    car = _a.sent();
                    return [4 /*yield*/, listAvailableCarsUseCase.execute({ name: "Car3" })];
                case 2:
                    cars = _a.sent();
                    expect(cars).toEqual([car]);
                    return [2 /*return*/];
    ...
    it("should be able to list all available cars by category", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    car = _a.sent();
                    return [4 /*yield*/, listAvailableCarsUseCase.execute({ category_id: "12345" })];
                case 2:
                    cars = _a.sent();
                    expect(cars).toEqual([car]);
                    return [2 /*return*/];
