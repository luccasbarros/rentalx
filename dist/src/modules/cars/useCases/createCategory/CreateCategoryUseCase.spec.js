...
describe("Create Category", function () {
    ...
    it("should be not able to create a new category with same name", function () { return __awaiter(void 0, void 0, void 0, function () {
        var category;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, expect(createCategoryUseCase.execute({
                            name: category.name,
                            description: category.description,
                        })).rejects.toEqual(new AppError_1.AppError("Category already exists", 400))];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
