...
describe("Authenticate User", function () {
    ...
    it("should not be able to authenticate non existed user", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(authenticateUserUseCase.execute({
                        email: "false@mail.com",
                        password: "1234",
                    })).rejects.toEqual(new AppError_1.AppError("Email or password incorrect", 401))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
